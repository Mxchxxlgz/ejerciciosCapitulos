...
namespace cap5_17
{
    class program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Seleccione un número < 4000 y > 0: ");
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("El número digitado sobre pasa el limite");
                    v = false;
                    break;
                }
                if (n == 0)
            ...
            if (v)
                Console.WriteLine("");
            Console.WriteLine("El número digitado en romano es: " + resultado);
            Console.ReadKey();
        }
    }
}